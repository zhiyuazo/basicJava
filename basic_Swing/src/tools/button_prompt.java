...
public class button_prompt {
	public static void main(String[] args) {
		...
		JToolBar tb = new JToolBar();
			JButton b1 = new JButton(new ImageIcon("test1.jpg")); b1.setToolTipText("no.4 baby's image-1"); // add JButon prompt 
			JButton b2 = new JButton(new ImageIcon("test2.jpg")); b2.setToolTipText("no.4 baby's image-2");
			JButton b3 = new JButton(new ImageIcon("test3.jpg")); b3.setToolTipText("no.4 baby's image-3");
			tb.add(b1);	
			tb.add(b2);	
			tb.add(b3);	
			tb.setPreferredSize(new Dimension(500,200));;
			tb.setFloatable(false);      //make Tool Bar fixed, not changed via Mouse.. 
